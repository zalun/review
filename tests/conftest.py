...
def in_process(monkeypatch, safe_environ, request):
    ...
    # Allow to define the Telemetry.submit function in the testing module
    telemetry_submit = getattr(request.module, "telemetry_submit", mock.Mock())
    monkeypatch.setattr(telemetry.telemetry, "submit", telemetry_submit)
